...
-- Listage des données de la table iformat.plannings : ~5 rows (environ)
...
-- Listage des données de la table iformat.presences : ~4 rows (environ)
...
INSERT INTO `users` (`id`, `first_name`, `last_name`, `email`, `phone_number`, `address`, `gender`, `from`, `department`, `fonction`, `user_role_id`, `user_created_by`, `user_updated_by`, `email_verified_at`, `password`, `status`, `active`, `remember_token`, `created_at`, `updated_at`) VALUES
	(1, 'Admin', 'Super', 'admin@gmail.com', '66666666', NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, '$2y$10$zmHrqdDegQRc41t0INK5uOODuJk35q0kEt9kil5Kd57pw.vYHEBnS', 1, 1, NULL, '2022-04-29 07:34:01', '2022-07-14 05:51:27'),
