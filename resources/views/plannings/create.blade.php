                        ...
                        <form class="form" action="<?= isset($old_planning) ? route('listPlannings.update') : route('listPlannings.store') ?>" method="post" id="create_modal_from">
                            ...
                            <div class="col-md-12">
                                <div class="row fv-row fv-plugins-icon-container" _mstvisible="11">
                                    ...
                                    <div class="col-md-4" _mstvisible="12">
                                        <div class="d-flex flex-column mb-5 fv-row  text-dark">
                                            ...
                                            <div class="fv-plugins-message-container invalid-feedback">
                                                <div data-field="first_name" data-validator="notEmpty">{{$errors->first('plannings_user_groups')}}</div>
                                            </div>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12" _mstvisible="12">
                                        <div class="d-flex flex-column mb-5 fv-row  text-dark">
                                            ...
                                            <div class="fv-plugins-message-container invalid-feedback">
                                                <div data-field="first_name" data-validator="notEmpty">{{$errors->first('plannings_teachers')}}</div>
                                            </div>
                                            @endif
                                        </div>
                                    </div>
                                ...
                                <div class="row fv-row " data-select2-id="select2-data-126-fvxd" id="plan_opt2">
                                    <!--begin::Col-->
                                    <div class="col-3" data-select2-id="select2-data-125-pfr6">
                                        <!--begin::Label-->
                                        <label class="fw-bolder text-dark fs-6 mb-2 required">Date Début</label>
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input class="form-control form-control-solid" placeholder="" name="plannings_begin" type="date" min="<?= date('Y-m-d') ?>" id="plannings_begin" />
                                        <!--end::Input-->
                                    ...
                                    <div class="col-3" data-select2-id="select2-data-125-pfr6">
                                        <!--begin::Label-->
                                        <label class="fw-bolder text-dark fs-6 mb-2 required">Date Fin</label>
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input class="form-control form-control-solid" placeholder="" name="plannings_end" type="date" min="<?= date('Y-m-d') ?>" id="plannings_end" />
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Col-->
                                    <!--begin::Col-->
                                    <div class="col-md-4" _mstvisible="12">
                                        <div class="d-flex flex-column mb-5 fv-row  text-dark">
                                            ...
                                            <div class="fv-plugins-message-container invalid-feedback">
                                                <div data-field="plannings_time_slot" data-validator="notEmpty">{{$errors->first('plannings_time_slot')}}</div>
                                            </div>
                                            @endif
                                        </div>
                                    </div>
...
<script type="text/javascript">
    ...
    $("#plannings_begin").change(function(e) {
        ...
        const plannings_end = document.getElementById('plannings_end');
        plannings_end.min = val;
        plannings_end.value = val;

    });
    $("#plannings_end").change(function(e) {
        val = e.currentTarget.value;
        const plannings_begin = document.getElementById('plannings_begin');
        plannings_begin.max = val;
