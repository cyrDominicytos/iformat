					...
					<form class="form w-100" novalidate="novalidate" id="kt_sign_up_form" action="<?= isset($old_user) ? route('user.edit') : route('register') ?>" method="post">
						...
						<div class="text-center mb-10">
							...
							<div class="text-gray-400 fw-bold fs-4">Retournez à votre
								<a href="{{ route('home') }}" class="link-primary fw-bolder"> espace de travail</a>
							</div>
							<!--end::Link-->
						...
						<div class="row fv-row mb-7">
							...
							<div class="col-xl-6">
								...
								<div class="fv-plugins-message-container invalid-feedback">
									<div data-field="last_name" data-validator="notEmpty">{{$errors->first('last_name')}}</div>
								</div>
								@endif
							</div>
							<!--end::Col-->
							...
							<div class="col-xl-6">
								...
								<div class="fv-plugins-message-container invalid-feedback">
									<div data-field="first_name" data-validator="notEmpty">{{$errors->first('first_name')}}</div>
								</div>
								@endif
							</div>
							<!--end::Col-->
						...
						<div class="row fv-row mb-7">
							...
							<div class="col-xl-6">
								...
								<div class="fv-plugins-message-container invalid-feedback">
									<div data-field="phone_number" data-validator="notEmpty">{{$errors->first('phone_number')}}</div>
								</div>
								@endif
							</div>
							<!--end::Col-->
						...
						<div class="row fv-row mb-7">
							<div class="col-md-6" _mstvisible="12">
								<div class="d-flex flex-column mb-5 fv-row  text-dark">
									...
									<div class="fv-plugins-message-container invalid-feedback">
										<div data-field="department" data-validator="notEmpty">{{$errors->first('department')}}</div>
									</div>
									@endif
								</div>
							</div>
							...
							<div class="col-md-6" _mstvisible="12">
								...
								<div class="fv-plugins-message-container invalid-feedback">
									<div data-field="last_name" data-validator="notEmpty">{{$errors->first('address')}}</div>
								</div>
								@endif
							</div>
							<!--end::Col-->
						...
						<div class="row fv-row mb-7">
							...
							<div class="col-md-6" _mstvisible="12">
								<div class="d-flex flex-column mb-5 fv-row  text-dark">
									...
									<select name="from" data-control="select2" data-placeholder="Choisissez l'institution..." class="form-select form-select-solid form-select-lg fw-bold select2-hidden-accessible" data-select2-id="select2-data-10-02r3" tabindex="-1" aria-hidden="true" id="from">
									...
									@if($errors->has('from'))
									<div class="fv-plugins-message-container invalid-feedback">
										<div data-field="from" data-validator="notEmpty">{{$errors->first('from')}}</div>
									</div>
									@endif
								</div>
							</div>
						...
						<div class="mb-10 fv-row" data-kt-password-meter="true">
							...
							<div class="mb-1">
								...
								<div class="position-relative mb-3">
									...
									<div class="fv-plugins-message-container invalid-feedback">
										<div data-field="last_name" data-validator="notEmpty">{{$errors->first('password')}}</div>
									</div>
									@endif
								</div>
								<!--end::Input wrapper-->
...
<-end::Content-->
	...
	<script type="text/javascript">
		var old_user = <?php echo  isset($old_user) ? json_encode($old_user) : (0); ?>;
		//console.log(old_user['from'])
		$(window).on('load', function() {
			if (old_user != 0) {
				//alert(old_user['department'])
				$("#department").val(old_user['department']);
				$("#from").val(old_user['from']);
