    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1"> Gestion des présences aux examens ICDL</h1>
                <!--end::Title-->
                <!--begin::Separator-->
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted text-capitalize">Certification ICDL</li>
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item">
                        <span class="bullet bg-gray-300 w-5px h-2px"></span>
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-dark">Liste de présence</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
            ...
            <div class="card">
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-title">
                        <h4 class="fw-bolder text-dark">Consulter la liste de présence des participants</h4>
                    </div>
                    <!--begin::Card title-->
                    <!--begin::Card toolbar-->
                ...
                <div class="card-body py-4">
                    <div class="row">
                        <form class="form" action="<?=  route('listExamPresence.print') ?>" method="post" id="create_modal_from">
                            @csrf
                            @isset($old_planning):
                            ...
                            <div class="col-md-12">
                                ...
                                <h4 class="fw-bolder text-dark text-center mt-5 mb-5">Liste de présence des participants</h4>
                                ...
                                <div>
                                    ...
                                    <div class="modal-footer flex-center" style="margin-top: 10px">
                                        ...
                                        <!--end::Button-->
                                        <!--begin::Button-->
                                        <button type="submit" class="btn btn-success" name="preview" value="preview">
                                            <span class="indicator-label" id="submitText">Visualiser</span>
                                            <span class="indicator-progress">Patientez...
                                                <span class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
                                        </button>
                                        <!--end::Button-->
                                        <!--begin::Button-->
                                        <button type="submit"  class="btn btn-primary" name="print" value="print">
                                            <span class="indicator-label" id="submitText">Imprimer</span>
                                            <span class="indicator-progress">Patientez...
                                                <span class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
                                        </button>
                                        <!--end::Button-->
...
if ($(this).val() != '') {
    ...
    //load product code
    $.ajax({
        url: "<?= route('listExamPresence.get_learning_groups') ?>",
        type: "POST",
        data: {
            id: value,
        },
...
if ($(this).val() != '') {
    ...
    $.ajax({
        url: "<?= route('listExamPresence.get_exam_group_participant_list') ?>",
        type: "POST",
        data: {
            id: $('#plannings_learning_id').val(),
            group_id: value,
        },
        success: function(result) {
