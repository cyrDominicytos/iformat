				...
				<div class="card-body" id="kt_engage_demos_body">
					...
					<div id="kt_explore_scroll" class="scroll-y me-n5 pe-5" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-wrappers="#kt_engage_demos_body" data-kt-scroll-dependencies="#kt_engage_demos_header" data-kt-scroll-offset="5px">
						...
						<div class="mb-0">
							...
							<!--begin::Demos-->
							<div class="mb-0">
								<h3 class="fw-bolder text-center mb-6">Aside right</h3>
								<!--begin::Row-->
								<div class="row g-5">
									...
									<div data-kt-stepper-element="content">
										<div class="w-100 text-center">
											...
											<div class="text-center px-4 py-15">
												<img src="{{ asset('assets/media/illustrations/unitedpalms-1/9.png')}}" alt="" class="mw-100 mh-300px" />
											</div>
											<!--end::Illustration-->
										</div>
									</div>
							...
							<div class="py-5">
								...
								<div data-kt-search-element="empty" class="text-center d-none">
									...
									<div class="text-center px-5">
										<img src="{{ asset('assets/media/illustrations/unitedpalms-1/1.png')}}" alt="" class="w-100 h-200px h-sm-325px" />
									</div>
									<!--end::Illustration-->
								</div>
								<!--end::Empty-->
